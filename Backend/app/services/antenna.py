...
class AntennaService():
    ...
    def __init__(self):
        ...
        self.interventionRepository = InterventionRepository()
    ...
    def lis_antenna(
            ...
            *,
            ...
            status: AntennaStatus | None = None,
              ...
              antennas = self.antennaRepository.get_antenna(
                    db,
                    limit=limit,
                    offset=offset,
                    city=city,
              ...
              antennas_ids = [antenna.id for antenna in antennas]

              latest_interventions = InterventionRepository.get_last_intervention_by_antenna_ids(
                    db,
                    antennas_ids
              )
